# Agent Onboarding — team_110 / nimrod-bio

*Generated 2026-05-26T19:24:17.365150Z  ·  Depth: full*

## Activation TL;DR
- **Identity:** team_110 · engine: cursor-composer-2 · role: Team 110
- **Domain:** nimrod-bio · profile: L0
- **Assignment:** WP=NB-S002-P006-WP001 —  · gate=—
- **Task:** STATUS NB-V200-P006-WP001 blocked at 5.1
- **Writes to (first 3):** `_COMMUNICATION/team_110/`
- **First reads:** `CLAUDE.md` · `_aos/governance/team_110.md` · `_aos/roadmap.yaml`
- **State:** team=team_110 project=nimrod-bio wp=NB-S002-P006-WP001 gate=— depth=full
...
## Project Context
- **Project:** nimrod.bio — Personal Site (WordPress)
- **Profile:** L0
- **Type:** spoke
- **Enabled:** True
- **Local path:** `/data/projects/nimrod-bio` *(machine-local — your checkout may differ)*
...
## Session Task
STATUS NB-V200-P006-WP001 blocked at 5.1
...
**Completion criteria:** Report the deliverable path + a one-line summary to Team 00 via `_COMMUNICATION/team_110/` (respecting your writes_to permission) when done.
