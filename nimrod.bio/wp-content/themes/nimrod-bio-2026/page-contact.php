...
<article class="t8 t8-contact">
	<section class="page-hero">
		<div class="t8-wrap">
			<div class="eyebrow"><span class="num">צור קשר</span><span>· מארח</span></div>
			<h1>דבר איתי</h1>
			<p class="lede">
			...
			<div class="hero-act">
				<a href="https://wa.me/972547776770" class="btn btn-wa" target="_blank" rel="noopener noreferrer">
				...
				<a href="#nb-contact" class="btn btn-ghost">לטופס למטה</a>
			</div>
		</div>
	</section>
