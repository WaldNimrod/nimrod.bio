...
$events = array(
	...
	array(
		...
		'body'  => '1.2 דונם הפכו למעבדה. כל עונה מקרה — שנה ירודה אחת (בצורת + עכבר השדה), שנה שיא אחת. ~80 לקוחות קבועים, סלים לבעלי-בית ותוצרת למסעדה. תיעוד שבועי שיהיה הבסיס לכל מה שיבוא אחרי.',
		'cls'   => '',
	),
	array(
		'year'  => 'סתיו 2023',
	...
	array(
		...
		'body'  => '240 מ״ר. NFT. תשתית מקצועית במקום שדה. מספקת תוצרת מתועדת קבועה למסעדה שמוכנה לעבוד בתנאים שלנו, ומשמשת מעבדה לכל הייעוץ.',
		'cls'   => '',
	),
	array(
		'year'  => '2024–2025',
		'title' => 'ייעוץ ותכנון חממות',
		'body'  => 'תכנון, אבחון, ליווי. הידע שצברתי בגינה ובחממה שלי, נכנס לחממות של אחרים — וחוזר אליי כתיעוד נוסף.',
		'cls'   => 'know',
	),
	array(
		'year'  => '2026 →',
		'title' => 'SFA · Small Farm Agents',
		'body'  => 'כלי קהילתי וחינמי לחקלאות הקטנה, על בסיס מקרים מהשטח. v0.1 בבנייה — לסוף 2026.',
		'cls'   => 'code',
	),
);
?>
