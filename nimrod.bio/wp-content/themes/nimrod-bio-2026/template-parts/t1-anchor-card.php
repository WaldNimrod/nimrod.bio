...
if ( '' === $lede ) {
	// Project anchors (e.g. SFA on the code world) carry copy in _nb_summary.
	$lede = nb_meta( $post->ID, 'summary' );
}
...
<div class="lat-anchor anchor-card">
	...
	<?php else : ?>
		<?php echo nb_img_placeholder( get_the_title( $post ), get_the_title( $post ), 'auto', 'anchor-img clean' ); ?>
	<?php endif; ?>
